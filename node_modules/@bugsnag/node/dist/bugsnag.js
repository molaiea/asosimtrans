...
var __getStack_40 = _$nodeFallbackStack_23.getStack,
    __maybeUseFallbackStack_40 = _$nodeFallbackStack_23.maybeUseFallbackStack;
...
var _$intercept_40 = {
  ...
  load: function (client) {
    var intercept = function (onError, cb) {
      ...
      var fallbackStack = __getStack_40();
      return function (err) {
        if (err) {
          // check if the stacktrace has no context, if so, if so append the frames we created earlier
          if (err.stack) __maybeUseFallbackStack_40(err, fallbackStack);
          var event = client.Event.create(err, true, {
            severity: 'warning',
            unhandled: false,
            severityReason: {
...
var _$device_41 = {
  load: function (client) {
    var device = {
      osName: __os_41.platform() + " (" + __os_41.arch() + ")",
      osVersion: __os_41.release(),
      totalMemory: __os_41.totalmem(),
    ...
    client._addOnSessionPayload(function (sp) {
      sp.device = ___extends_41({}, sp.device, {}, device);
    }); // add time just as the event is sent


    client.addOnError(function (event) {
      event.device = ___extends_41({}, event.device, {}, device, {
        freeMemory: __os_41.freemem(),
        time: new Date()
      });
    }, true);
  }
...
function ___extends_43() { ___extends_43 = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; return ___extends_43.apply(this, arguments); }
...
var ___require_43 = require("fs"),
    createReadStream = ___require_43.createReadStream;

var ___require2_43 = require("stream"),
    Writable = ___require2_43.Writable;

var pump = require("pump");

var byline = require("byline");

var _$surroundingCode_43 = {
  load: function (client) {
...
function (_Writable) {
  ...
  function CodeRange(opts) {
    ...
    _this = _Writable.call(this, ___extends_43({}, opts, {
      decodeStrings: false
    })) || this;
...
var _$unhandledRejection_45 = {
  load: function (client) {
    if (!client._config.autoDetectErrors || !client._config.enabledErrorTypes.unhandledRejections) return;

    ___handler_45 = function (err) {
      var event = client.Event.create(err, false, {
        severity: 'error',
        unhandled: true,
        severityReason: {
    ...
    process.on('unhandledRejection', ___handler_45);
  },
  destroy: function () {
    process.removeListener('unhandledRejection', ___handler_45);
  }
};
...
function ___inheritsLoose_48(subClass, superClass) { subClass.prototype = Object.create(superClass.prototype); subClass.prototype.constructor = subClass; subClass.__proto__ = superClass; }
...
/*#__PURE__*/
function (_Emitter) {
  ___inheritsLoose_48(SessionTracker, _Emitter);
...
/* removed: var _$tracker_48 = require('./tracker'); */;

/* removed: var _$Backoff_46 = require('backo'); */;

/* removed: var _$syncCallbackRunner_25 = require('@bugsnag/core/lib/sync-callback-runner'); */;

var _$session_47 = {
  load: function (client) {
    var sessionTracker = new _$tracker_48(client._config.sessionSummaryInterval);
...
/* removed: var _$surroundingCode_43 = require('@bugsnag/plugin-node-surrounding-code'); */;

/* removed: var _$inProject_42 = require('@bugsnag/plugin-node-in-project'); */;

/* removed: var _$stripProjectRoot_49 = require('@bugsnag/plugin-strip-project-root'); */;

/* removed: var _$session_47 = require('@bugsnag/plugin-server-session'); */;

/* removed: var _$device_41 = require('@bugsnag/plugin-node-device'); */;

/* removed: var _$uncaughtException_44 = require('@bugsnag/plugin-node-uncaught-exception'); */;

/* removed: var _$unhandledRejection_45 = require('@bugsnag/plugin-node-unhandled-rejection'); */;

/* removed: var _$intercept_40 = require('@bugsnag/plugin-intercept'); */;

/* removed: var _$contextualize_39 = require('@bugsnag/plugin-contextualize'); */;

var internalPlugins = [_$app_38, _$surroundingCode_43, _$inProject_42, _$stripProjectRoot_49, _$session_47, _$device_41, _$uncaughtException_44, _$unhandledRejection_45, _$intercept_40, _$contextualize_39];
var Bugsnag = {
  _client: null,
